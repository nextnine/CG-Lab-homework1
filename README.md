...
本项目是一个基于 **Taichi + GPU 并行计算** 的图形学实验,能够实现如下功能：
- 在窗口中实时模拟大量粒子运动；
- 鼠标位置作为“引力源”吸引粒子；
- 粒子具有阻力衰减与边界反弹效果。
- 能够适应最大化最小化等窗口大小的变化
...
仓库中已包含演示视频，可直接查看：![VideoProject-ezgif com-video-to-gif-converter](https://github.com/user-attachments/assets/dcfec9b1-41c2-449d-b0bb-ca1f1ee9af46)
